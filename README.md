...
![版本](https://img.shields.io/badge/版本-1.0.0-blue) ![许可证](https://img.shields.io/badge/许可证-MIT-green) ![PWA](https://img.shields.io/badge/PWA-支持-brightgreen)
...
双击 `index.html` 即可使用（部分功能需要本地服务器）
...
> ⚠️ 注意：局域网访问无法使用 Service Worker 离线功能，需 HTTPS 环境
